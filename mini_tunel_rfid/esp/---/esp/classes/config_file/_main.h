...
private:
	...
	void save_parameter(String parameter)
	{
		...
		else if (parameter.startsWith("resulst_0="))
		{
			parameter.replace("resulst_0=", "");
			box_results[0] = parameter.toInt();
		}
		else if (parameter.startsWith("resulst_1="))
		{
			parameter.replace("resulst_1=", "");
			box_results[1] = parameter.toInt();
		}
		else if (parameter.startsWith("resulst_2="))
		{
			parameter.replace("resulst_2=", "");
...
public:
	void save_config()
	{
		...
		writeFile("resulst_0=" + String(box_results[0]));
		writeFile("resulst_1=" + String(box_results[1]));
		writeFile("resulst_2=" + String(box_results[2]));
	}
